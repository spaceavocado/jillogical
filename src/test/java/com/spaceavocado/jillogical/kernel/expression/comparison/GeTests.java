...
public class GeTests {
    private static Stream<Arguments> evaluateData() {
        return Stream.of(
            ...
            Arguments.of(new Value(1.1), new Value(1.1), true),
            Arguments.of(new Value(1.1f), new Value(1.1f), true),
            Arguments.of(new Value(2), new Value(1), true),
            Arguments.of(new Value(1.2), new Value(1.1), true),
            Arguments.of(new Value(1.2f), new Value(1.1f), true),
            // Falsy
            Arguments.of(new Value(1), new Value(2), false),
            Arguments.of(new Value(1.0f), new Value(1.1f), false),
    ...
    public void evaluate(IEvaluable left, IEvaluable right, boolean expected) {
        var expression = new Ge(left, right);
